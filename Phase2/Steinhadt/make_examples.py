...
h5f = h5py.File('old_datasets/training_2D.h5', 'w')
h5f.create_dataset('x', data=x)
h5f.create_dataset('y', data=y)
h5f.close()

h5f = h5py.File('old_datasets/slab_2D.h5', 'w')
h5f.create_dataset('x', data=xslab)
h5f.create_dataset('y', data=yslab)
h5f.close()

if os.path.isfile('datasets/data.zip'):
    os.system('rm old_datasets/data.zip')
os.system('zip -r old_datasets/data.zip old_datasets')
os.system('rm old_datasets/training_2D.h5')
os.system('rm old_datasets/slab_2D.h5')
